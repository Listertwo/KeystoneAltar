...
public class KeystoneAltarMod
{
    ...
    private void doClientStuff(final FMLClientSetupEvent event) {
        event.enqueueWork(() -> {
            RenderTypeLookup.setRenderLayer(ModBlocks.AMETHYST_GEODE.get(), RenderType.getCutout());
            RenderTypeLookup.setRenderLayer(ModBlocks.KEYSTONE_ALTAR.get(), RenderType.getCutout());

            ScreenManager.registerFactory(ModContainers.KEYSTONE_ALTAR_CONTAINER.get(), KeystoneAltarScreen::new);
        });
